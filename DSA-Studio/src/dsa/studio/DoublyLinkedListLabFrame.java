...
/**
 * The Doubly Linked List Lab window. Same animation pattern as the
 * other labs, wired to DSDoublyLinkedList and displayed with two-way
 * arrows through DListBoxPanel.
 */
public class DoublyLinkedListLabFrame extends JFrame implements ActionListener {

    private DSDoublyLinkedList dsList;
    private DListBoxPanel boxPanel;
    ...
    private JButton deleteBtn, searchBtn, reverseTraverseBtn, backBtn;

    private Timer timer;
    private List<AnimationStep> frameQueue;
    private int animationDelay = 500;

    public DoublyLinkedListLabFrame() {
        dsList = new DSDoublyLinkedList();
        frameQueue = new LinkedList<AnimationStep>();

        setTitle("DSA Studio - Doubly Linked List Lab");
        setSize(820, 480);
    ...
    private void addComponents() {
        titleLabel = new JLabel("Linked List Lab (Doubly Linked)");
        ...
        reverseTraverseBtn = makeButton("Backward Traverse", 300, y2);
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        } else if (cmd.equals("Backward Traverse"))
        {
            playSteps(dsList.reverseTraverse());
