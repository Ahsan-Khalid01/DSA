...
/**
 * Shows a linked list as boxes connected by arrow labels, so it visually
 * reads as a chain instead of a plain row like the array display.
 */
public class ListBoxPanel extends JPanel {
    ...
    public ListBoxPanel(int maxNodes) {
        setLayout(null);
